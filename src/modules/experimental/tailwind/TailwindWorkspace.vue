...
.care-poster{position:relative;isolation:isolate;grid-column:span 4;aspect-ratio:4/5;min-width:0;overflow:hidden;background:#111722;box-shadow:0 20px 48px rgba(0,0,0,.32);animation:care-poster-arrive var(--dur-3) cubic-bezier(.16,1,.3,1) both;animation-delay:calc(var(--poster-index) * var(--dur-1))}
...
.care-image-stage input{position:absolute;z-index:4;inset:0;width:100%;height:100%;opacity:0;cursor:pointer}.care-image-stage>span{display:grid;justify-items:center;gap:.75rem;padding:2rem;text-align:center}.care-image-stage>span svg{width:2rem;color:var(--workspace-accent)}.care-image-stage>span strong{font-size: var(--texto-6);font-weight:300}.care-image-stage>span small{color:#aaa398;font: 500 var(--texto-1)/1.5 system-ui,sans-serif}.care-image-stage>img{width:100%;height:100%;object-fit:cover}.care-image-stage>em{position:absolute;z-index:3;right:1.2rem;bottom:1.2rem;padding:.55rem .7rem;background:rgba(8,11,17,.84);color:#ead6a7;font: 600 var(--texto-1)/1 system-ui,sans-serif;font-style:normal}.care-image-stage.loading{cursor:wait;opacity:.68}
...
.care-image-error{margin:0;color:#efb8a8;font: var(--texto-2)/1.5 system-ui,sans-serif}.care-publish{justify-self:end;min-width:11rem;min-height:46px;padding:.7rem 1rem;border:1px solid #c9a86a;border-radius:14px;background:rgba(201,168,106,.13);color:#ead6a7;font: 600 var(--texto-2)/1 system-ui,sans-serif;cursor:pointer}.care-publish:disabled{cursor:not-allowed;opacity:.48}
...
.constellation-thread{stroke:color-mix(in srgb,var(--star-color) 22%,transparent);stroke-width:.18;stroke-dasharray:.8 1.4;animation:constellation-thread-arrive var(--dur-3) cubic-bezier(.16,1,.3,1) both}
...
.constellation-reading strong{overflow-wrap:anywhere;font-size: var(--texto-4);font-weight:400}
.constellation-reading small{grid-column:2;color:#bdb5c7;font: 500 var(--texto-1)/1.4 system-ui,sans-serif}
...
.constellation-reading>p{grid-column:1/-1;margin:.7rem 0 0;color:#d8d1c6;font-size: var(--texto-3);line-height:1.55}
.constellation-reading-enter-active,.constellation-reading-leave-active{transition:opacity var(--dur-2) ease}.constellation-reading-enter-active.constellation-reading,.constellation-reading-leave-active.constellation-reading{transition:opacity var(--dur-2) ease,filter var(--dur-2) ease,transform var(--dur-3) cubic-bezier(.16,1,.3,1)}.constellation-reading-enter-from,.constellation-reading-leave-to{opacity:0;filter:blur(4px);transform:translate(-50%,.75rem) scale(.96)}
...
.constellation-legend li{display:grid;grid-template-columns:.6rem minmax(0,auto);align-items:center;gap:.2rem .5rem;color:#ddd6cc;font: 500 var(--texto-1)/1.35 system-ui,sans-serif}
...
.thought-cloth>.thought-point span::after{content:'';position:absolute;inset:-7px;border:1px solid color-mix(in srgb,var(--thought-color) 32%,transparent);border-radius:50%;transform:scale(.72);transition:transform var(--dur-2) cubic-bezier(.16,1,.3,1),border-color var(--dur-2) ease}
...
.journey-picker{display:grid;gap:.6rem}.journey-picker label{color:#b9b3aa;font: 600 var(--texto-1)/1.3 system-ui,sans-serif;text-transform:uppercase;letter-spacing:.06em}.journey-picker>div{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:.6rem}.journey-picker>div input{min-width:0;min-height:48px;border:0;border-bottom:1px solid rgba(125,167,151,.42);outline:0;background:transparent;color:#f4efe5;padding:.65rem .15rem;font: var(--texto-4)/1.4 Georgia,'Times New Roman',serif}.journey-picker>div input:focus-visible{border-bottom-color:#ead6a7;box-shadow:0 2px #ead6a7}.journey-picker>div button{min-height:44px;border:1px solid rgba(201,168,106,.42);border-radius: var(--radio-pill);background:rgba(201,168,106,.1);color:#ead6a7;padding:.65rem 1rem;font: 600 var(--texto-2)/1 system-ui,sans-serif;cursor:pointer}.journey-picker>div button:disabled{cursor:wait;opacity:.55}.journey-results{display:grid;max-height:14rem;margin:0;padding:.3rem;overflow:auto;border:1px solid rgba(125,167,151,.32);border-radius: var(--radio-md);background:#0d121b;list-style:none}.journey-results button{width:100%;min-height:44px;border:0;border-bottom:1px solid rgba(125,167,151,.14);background:transparent;color:#e3f0e8;padding:.6rem .7rem;text-align:left;cursor:pointer}.journey-results button:is(:hover,:focus-visible){outline:0;background:rgba(125,167,151,.12);color:#f4efe5}.journey-selected-place{display:grid;gap:.35rem;padding:.85rem 0;border-block:1px solid rgba(125,167,151,.2)}.journey-selected-place small{color:#b9c9c1;font: 600 var(--texto-1)/1.3 system-ui,sans-serif;text-transform:uppercase;letter-spacing:.08em}.journey-selected-place strong{color:#e3f0e8;font-size: var(--texto-5);font-weight:300}.journey-selected-place.empty strong{color:#a9b9b2;font-size: var(--texto-4);font-style:italic}.journey-location-message{margin:0;color:#b9c9c1;font: var(--texto-2)/1.45 system-ui,sans-serif}
...
.care-inscription-editor input{min-height:2.25rem;padding:.3rem .1rem;font: 300 var(--texto-3)/1.35 Georgia,'Times New Roman',serif}
