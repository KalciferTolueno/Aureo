...
.detail-balance .balance-reading>.balance-heading,.detail-balance .balance-reading>.balance-actions{display:none}
...
@media(max-width:760px){.workspace-primary{min-height:44px;padding:.6rem .9rem}.ritual-form,.nucleus-entry,.golden-entry{padding:.95rem;gap:.85rem}.ritual-form{padding:.95rem}.workspace-text,.workspace-back{min-height:40px}.daruma-progress button,.daruma-transfer{padding:.5rem .7rem}.balance-reading>div button,.segmented-choice button{padding:.6rem .85rem}}
