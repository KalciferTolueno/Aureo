...
.capture-seal-panel { position: relative; width: min(100%, 21.5rem); overflow: hidden; padding: 1rem 1.05rem 1.05rem; border: 1px solid rgba(201, 168, 106, .32); border-radius: var(--radio-organico-2); outline: 0; background: radial-gradient(circle at 88% 0, rgba(201, 168, 106, .12), transparent 34%), #0d121b; box-shadow: 0 24px 70px rgba(0, 0, 0, .55); }
...
.capture-seal-panel h2 { margin: 0; color: #f4efe5; font: 300 var(--texto-5)/1.1 Fraunces, 'Aureo Serif', Georgia, serif; letter-spacing: -.02em; }
...
.capture-seal-field span { color: var(--texto-suave); font: 500 var(--texto-1)/1 system-ui, sans-serif; letter-spacing: .12em; text-transform: uppercase; }
